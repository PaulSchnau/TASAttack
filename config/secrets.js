...
module.exports = {
    ...
    db: process.env.MONGOLAB_URI || process.env.MONGODB || 'mongodb://mongouser:mongopassword.mongolab.com:27771/heroku_app512243',
    ...
    twitter: {
        consumerKey: process.env.TWITTER_KEY || 'MZUpNj9RjDhsfdSJjf7spqr',
        consumerSecret: process.env.TWITTER_SECRET  || 'vfY1NoId4OnGWENj9RjDhsfdSJjf7soSHCgJNMNxviPrrTPzq',
        access_token:         '2907108071-2pCrbGNj9RjDhsfdSJjf7sy9ag6kxvtCB1VYP',
        access_token_secret:  'd9R9DQSOhKVaNeEUpZNj9RjDhsfdSJjf7stO5gdZNn',
    ...
    twitch: {
        token: '4wacdn0qa0euip025sdfs434421sfdfo7'
    }
};
